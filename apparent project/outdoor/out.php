    ...
    if (mysqli_num_rows($query)) {
        while ($row = mysqli_fetch_array($query)) {
            ...
            if ($query->num_rows > 0) {
                $seene = $row["senee"];
                $out = $row["baheera"];
                 if(($seene=="seene") and ($out=="keessaa")){
                ...
                $garee = $row['baay’ina'];
                 ...
                 elseif(($seene=="hinseenne") and ($out=="keessaa")){
                    $mess = "Mammallii kun Hinseene ";
                 }
                 elseif(($seene=="seene") and ($out=="Baheera")){
                    $mess = "Mammallii kun Baheera ";
                 }
                 else{
                    $mess = "Dogoggora Qaba!";
                 }     
...
if(isset($_POST['sene'])){
  $idmam = $_POST['idmami'];
  $sql = "update person set baheera='Baheera' where IDMaammila='".$idmam."'";
                    ...
                    <div class="centertop">
                        ...
                        <ol>
                            ...
                            <li>
                              <div class="bottom">
                        <div class="sene">
                            <input type="submit" name="sene" value="Baheera">
                        </div>
                    </div>
                            </li>
                        </ol>
